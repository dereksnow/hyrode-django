...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'bookmarks_bookmark', 'path_id')

        # Adding M2M table for field bookmarks on 'Path'
        db.create_table(u'bookmarks_path_bookmarks', (
        ...
        db.create_unique(u'bookmarks_path_bookmarks', ['path_id', 'bookmark_id'])


    def backwards(self, orm):
        # Adding field 'Bookmark.path'
        db.add_column(u'bookmarks_bookmark', 'path',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bookmarks.Path'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field bookmarks on 'Path'
        db.delete_table('bookmarks_path_bookmarks')
