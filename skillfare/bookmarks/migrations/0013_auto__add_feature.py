...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bookmarks_feature', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'bookmarks', ['Feature'])

        # Adding M2M table for field features on 'Bookmark'
        db.create_table(u'bookmarks_bookmark_features', (
        ...
        db.create_unique(u'bookmarks_bookmark_features', ['bookmark_id', 'feature_id'])


    def backwards(self, orm):
        # Deleting model 'Feature'
        db.delete_table(u'bookmarks_feature')

        # Removing M2M table for field features on 'Bookmark'
        db.delete_table('bookmarks_bookmark_features')
    ...
    models = {
        ...
        u'bookmarks.choice': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'poll': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bookmarks.Poll']"}),
