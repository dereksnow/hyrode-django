...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SharedPath.user'
        db.delete_column(u'bookmarks_sharedpath', 'user_id')

        # Deleting field 'SharedPath.slug'
        db.delete_column(u'bookmarks_sharedpath', 'slug')

        # Deleting field 'SharedPath.personal'
        db.delete_column(u'bookmarks_sharedpath', 'personal')

        # Deleting field 'SharedPath.title'
        db.delete_column(u'bookmarks_sharedpath', 'title')
    ...
    def backwards(self, orm):
        # Adding field 'SharedPath.user'
        db.add_column(u'bookmarks_sharedpath', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'SharedPath.slug'
        db.add_column(u'bookmarks_sharedpath', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'SharedPath.personal'
        db.add_column(u'bookmarks_sharedpath', 'personal',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SharedPath.title'
        db.add_column(u'bookmarks_sharedpath', 'title',
