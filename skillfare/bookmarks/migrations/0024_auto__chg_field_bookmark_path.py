...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bookmark.path'
        db.alter_column(u'bookmarks_bookmark', 'path_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bookmarks.Path'], null=True))

    def backwards(self, orm):

        # Changing field 'Bookmark.path'
        db.alter_column(u'bookmarks_bookmark', 'path_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bookmarks.Path']))
    ...
    models = {
        ...
        u'bookmarks.bookmark': {
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'path': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bookmarks.Path']", 'null': 'True', 'blank': 'True'}),
