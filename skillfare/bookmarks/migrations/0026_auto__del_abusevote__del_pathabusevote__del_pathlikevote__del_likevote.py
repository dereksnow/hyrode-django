...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'PathAbuseVote'
        db.delete_table(u'bookmarks_pathabusevote')

        # Deleting model 'PathLikeVote'
        db.delete_table(u'bookmarks_pathlikevote')

        # Deleting model 'LikeVote'
        db.delete_table(u'bookmarks_likevote')

        # Adding model 'SharedPath'
        db.create_table(u'bookmarks_sharedpath', (
            ...
            ('path', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bookmarks.Path'], unique=True)),
        ))
        db.send_create_signal(u'bookmarks', ['SharedPath'])

        # Adding M2M table for field features on 'SharedPath'
        db.create_table(u'bookmarks_sharedpath_features', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sharedpath', models.ForeignKey(orm[u'bookmarks.sharedpath'], null=False)),
            ('feature', models.ForeignKey(orm[u'bookmarks.feature'], null=False))
        ))
        db.create_unique(u'bookmarks_sharedpath_features', ['sharedpath_id', 'feature_id'])

        # Adding model 'UserVote'
        db.create_table(u'bookmarks_uservote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ...
        db.send_create_signal(u'bookmarks', ['UserVote'])

        # Deleting field 'Path.hot_score'
        db.delete_column(u'bookmarks_path', 'hot_score')
    ...
    def backwards(self, orm):
        ...
        # Adding model 'PathAbuseVote'
        db.create_table(u'bookmarks_pathabusevote', (
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('path', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bookmarks.Path'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'bookmarks', ['PathAbuseVote'])

        # Adding model 'PathLikeVote'
        db.create_table(u'bookmarks_pathlikevote', (
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ...
        db.send_create_signal(u'bookmarks', ['PathLikeVote'])
        ...
        # Deleting model 'SharedPath'
        db.delete_table(u'bookmarks_sharedpath')

        # Removing M2M table for field features on 'SharedPath'
        db.delete_table('bookmarks_sharedpath_features')

        # Deleting model 'UserVote'
        db.delete_table(u'bookmarks_uservote')

        # Adding field 'Path.hot_score'
        db.add_column(u'bookmarks_path', 'hot_score',
