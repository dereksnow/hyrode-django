...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bookmark.search_index'
        db.add_column(u'bookmarks_bookmark', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Path.search_index'
        db.add_column(u'bookmarks_path', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bookmark.search_index'
        db.delete_column(u'bookmarks_bookmark', 'search_index')

        # Deleting field 'Path.search_index'
        db.delete_column(u'bookmarks_path', 'search_index')
