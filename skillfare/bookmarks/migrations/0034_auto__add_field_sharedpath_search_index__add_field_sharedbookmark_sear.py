...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SharedPath.search_index'
        db.add_column(u'bookmarks_sharedpath', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)

        # Adding field 'SharedBookmark.search_index'
        db.add_column(u'bookmarks_sharedbookmark', 'search_index',
                      self.gf('djorm_pgfulltext.fields.VectorField')(default='', null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SharedPath.search_index'
        db.delete_column(u'bookmarks_sharedpath', 'search_index')

        # Deleting field 'SharedBookmark.search_index'
        db.delete_column(u'bookmarks_sharedbookmark', 'search_index')
