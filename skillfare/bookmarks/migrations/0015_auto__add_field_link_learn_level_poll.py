...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'bookmarks_link', 'learn_level_poll',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['bookmarks.Poll'], unique=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'bookmarks.link': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'learn_level_poll': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['bookmarks.Poll']", 'unique': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
