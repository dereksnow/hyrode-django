...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'bookmarks_bookmark', 'path',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['bookmarks.Path']),
                      keep_default=False)

        # Deleting field 'Path.bookmark_ids'
        db.delete_column(u'bookmarks_path', 'bookmark_ids')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Path.bookmark_ids'
        db.add_column(u'bookmarks_path', 'bookmark_ids',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default=0, max_length=500),
                      keep_default=False)
