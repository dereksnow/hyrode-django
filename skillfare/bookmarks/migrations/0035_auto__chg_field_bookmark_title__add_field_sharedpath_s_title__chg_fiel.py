...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bookmarks_bookmark', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))
        # Adding field 'SharedPath.s_title'
        db.add_column(u'bookmarks_sharedpath', 's_title',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=100),
                      keep_default=False)


        # Changing field 'Path.title'
        db.alter_column(u'bookmarks_path', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))
        # Adding field 'SharedBookmark.s_title'
        db.add_column(u'bookmarks_sharedbookmark', 's_title',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=100),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Bookmark.title'
        db.alter_column(u'bookmarks_bookmark', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))
        # Deleting field 'SharedPath.s_title'
        db.delete_column(u'bookmarks_sharedpath', 's_title')


        # Changing field 'Path.title'
        db.alter_column(u'bookmarks_path', 'title', self.gf('django.db.models.fields.CharField')(max_length=200))
        # Deleting field 'SharedBookmark.s_title'
        db.delete_column(u'bookmarks_sharedbookmark', 's_title')
    ...
    models = {
        ...
        u'bookmarks.sharedbookmark': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            's_title': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'search_index': ('djorm_pgfulltext.fields.VectorField', [], {'default': "''", 'null': 'True', 'db_index': 'True'})
        },
