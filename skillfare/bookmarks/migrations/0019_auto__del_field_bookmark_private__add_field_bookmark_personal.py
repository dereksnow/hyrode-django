...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'bookmarks_bookmark', 'private')

        # Adding field 'Bookmark.personal'
        db.add_column(u'bookmarks_bookmark', 'personal',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'bookmarks_bookmark', 'private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Bookmark.personal'
        db.delete_column(u'bookmarks_bookmark', 'personal')
